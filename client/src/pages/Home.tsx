  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 md:py-32 bg-background">
        <div className="container mx-auto px-4 max-w-3xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/podcasts">
              <a>
                <Button className="w-full sm:w-auto bg-accent text-white hover:bg-accent/90 text-base px-8 py-6">
                  Écouter In Situ
            ...
            <Link href="/newsletter">
              <a>
                <Button variant="outline" className="w-full sm:w-auto border-2 border-accent text-accent hover:bg-accent/5 text-base px-8 py-6">
                  Rester Connecté
      ...
      <section className="py-20 md:py-32 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-foreground mb-12 leading-tight">
      ...
      <section className="py-20 md:py-32 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-foreground mb-16 leading-tight">
              Ce Que Nous Offrons
            </h2>
